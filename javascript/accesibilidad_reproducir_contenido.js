...
function responsive_voice(contenido,post){
    if (responsiveVoice.voiceSupport()) { 
        ...
        */      
        ...
        /*
        Se reproducira el contenido, asegurandonos que priviamente desde publicacion.php se limpio el codigo de todo caracter de html con la intencion de reproducir texto neto
        */
